...
if(roomChoice == "living room"):
    ...
    print("Do you want to steal the jewelry?")
    ...
    if(pitBullChoice == "yes"):
        ...
        print("You decide to not steal the dogs jewelry.")
    ...
    if(vaseChoice == "yes"):
        ...
        print("A dark figure with glowing read eyes launces at you, knocking you unconscious.")
        print("You wake up in your bed. It was all al dream.")
    else:
        print("Invalid choice. Please enter yes or no.")
else:
